...
import { useUpdateVideoMutation } from "../../../../store/service/blogVideo/blogVideoApiService";
import { FaSpinner } from "react-icons/fa";

const EditVideo = ({ editModal, setEditModal, editVideoData }) => {
  // video id
  const id = editVideoData?._id;
  // redux api
  ...
  const onSubmit = async (data) => {
    ...
    if (videoId) {
      ...
      const result = await updateVideo({ videoData, id });
  ...
  useEffect(() => {
    reset({
      ...
      url: editVideoData?.videoURL,
      shortDescription: editVideoData?.description,
    });
          ...
          <>
            <div className="py-10">
              <div className="flex justify-between items-center mb-5">
                <h1 className="font-bold text-blue-gray-800">Update Video</h1>
              </div>
