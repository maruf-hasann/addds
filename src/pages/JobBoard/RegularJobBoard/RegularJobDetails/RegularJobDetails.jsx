...
import RegularJobInfo from "./RegularJobInfo";
import RegularJobUserInfo from "./RegularJobUserInfo";
import { useLazyGetPersonalInfoQuery } from "../../../../store/service/personalInfo/personalInfoApiService";

const RegularJobDetails = () => {
  /* state  */
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 2xl:col-span-8 ">
            {/* Regular Info */}
            <RegularJobInfo singleJob={singleJob} />
            {/* Regular User Info */}
            <RegularJobUserInfo singleJobUserInfo={personalInfo} />
...
export default RegularJobDetails;
