...
const RegularJobInfo = ({ singleJob }) => {
      ...
      <div className="flex justify-between bg-white shadow-md pt-7 pb-3 px-4">
        <div>
          <h2 className="capitalize text-2xl font-semibold text-gray-800 ">
            {singleJob?.regularStatus} Regular Info
          </h2>
        </div>
        <div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="w-full rounded-md">
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Job Id</h4>
            ...
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Tutoring Place</h4>
              <h2 className="capitalize font-bold text-lg">
                {singleJob?.tutoringPlace}
              </h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Tutoring Category</h4>
              <h2 className="font-bold text-lg">
                {singleJob?.tutoringCategory}
              </h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Education Variant</h4>
              <h2 className="capitalize font-bold text-lg">
            ...
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Tutoring Variant</h4>
              <h2 className="capitalize font-bold text-lg">
          ...
          <div className="w-full rounded-md">
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Student Gender</h4>
              <h2 className="capitalize font-bold text-lg">
                {singleJob?.studentGender}
              </h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Preferred Gender</h4>
              <h2 className="capitalize font-bold text-lg">
            ...
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              ...
              <h2 className="capitalize font-bold text-lg">
                {singleJob?.grade ? singleJob?.grade : "No Info"}
              </h2>
            </div>

            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="capitalize font-medium text-sm mb-1">Institute</h4>
              <h2 className="font-bold text-lg">{singleJob?.institute}</h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Curriculum</h4>
              <h2 className="capitalize font-bold text-lg">
                {singleJob?.curriculum ? singleJob?.curriculum : "No Info"}
              </h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Location</h4>
              <h2 className="capitalize font-bold text-lg">
                {singleJob?.location ? singleJob?.location : "No Info"}
              </h2>
            </div>
            <div className="p-5 border-0 border-b-[1px] border-gray-200 bg-white">
              <h4 className="font-medium text-sm mb-1">Job Posted</h4>
              <h2 className="capitalize font-bold text-lg">
