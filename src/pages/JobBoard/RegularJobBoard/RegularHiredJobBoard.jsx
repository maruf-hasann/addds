...
const RegularHiredJobBoard = () => {
  ...
  // redux api call
  const { data: regularHiredJobsData, isLoading } = useGetAllJobsByStatusQuery({
    status: "hired",
    jobType: "Regular",
  });
      ...
      <DataTable
        ...
        columns={[
          ...
          { name: "Location", dataIndex: "location", key: "_id" },
          {
            name: "Regular Status",
            render: ({ item }) => (
              <span className="bg-gray-100 text-gray-800 text-base font-medium me-2 px-2.5 py-1 rounded border border-gray-400">
                {item?.regularStatus}
              </span>
            ),
          },
