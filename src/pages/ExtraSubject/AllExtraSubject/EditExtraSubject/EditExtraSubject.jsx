...
const EditExtraSubjectModal = ({
  setEditExtraSubjectData,
  editExtraSubjectData,
  setOpenEditExtraSubjectModal,
  openEditExtraSubjectModal,
}) => {
  const editExtraSubject = null;
  const isLoading = false;

  // handle close modal
  const handleClose = () => {
    setEditExtraSubjectData(null);
    setOpenEditExtraSubjectModal(!openEditExtraSubjectModal);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await editExtraSubject({ subject, type });
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 p-4 overflow-x-hidden overflow-y-auto inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-sm bg-white/5 ${
        openEditExtraSubjectModal ? "block" : "hidden"
      }`}
    >
            ...
            <div className=" grid grid-cols-1 gap-5">
              <div>
                ...
                <input
                  ...
                  name="type"
                  required
                  defaultValue={editExtraSubjectData?.type}
              ...
              <div>
                ...
                <input
                  ...
                  name="subject"
                  required
                  defaultValue={editExtraSubjectData?.subject}
...
export default EditExtraSubjectModal;
