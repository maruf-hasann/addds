...
const AddBoardWiseSubjectModal = ({
  openAddBoardWiseSubjectModal,
  setOpenAddBoardWiseSubjectModal,
}) => {
  ...
  // handle close modal
  const handleClose = () => {
    setOpenAddBoardWiseSubjectModal(!openAddBoardWiseSubjectModal);
  };
...
export default AddBoardWiseSubjectModal;
