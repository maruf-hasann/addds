    ...
    const transformSubjectArray = (inputArray) => {
        ...
        return inputArray.reduce((acc, item) => {
            const existingItem = acc.find(
                (i) => i.mainSubject === item.mainSubject
            );
            ...
            <DataTable
                ...
                columns={[
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.tutoringInfo?.tutoringVariant?.length
                                    ? item?.tutoringInfo?.tutoringVariant?.map(
                                          (variant, idx) => (
                                              <>
                                                  <span key={idx}>
                                                      {variant?.variantName}
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.tutoringInfo?.tutoringGrade?.length
                                    ? item?.tutoringInfo?.tutoringGrade?.map(
                                          (grade, idx) => (
                                              <>
                                                  <span key={idx}>
                                                      {grade?.gradeName}
                    ...
                    // additional tutoring info
                    {
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.additionalTutoringInfo
                                    ?.isGrowTutoringProgram
                                    ? "Yes"
                                    : "No"}
                            </div>
                        ),
                    },
                    {
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.additionalTutoringInfo?.tutoringProgram
                                    ?.length
                    ...
                    },
                    {
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.additionalTutoringInfo?.tutoringPlace
                                    ?.length
                    ...
                    },
                    {
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.additionalTutoringInfo?.studentVariant
                                    ?.length
                    ...
                    },
                    {
                        ...
                        render: ({ item }) => (
                            <div>
                                {item?.additionalTutoringInfo?.tutoringLocation
                                    ?.length
                        ...
                        render: ({ item }) => (
                            <div className="flex justify-between">
                                ...
                                {item?.promoInfo?.mediaGallery?.length ? (
                                    <p
                                        onClick={() => {
                                            setOpenPromoImagesModal(
                                                !openPromoImagesModal
                                            );
                                            setPromoImages(
                                                item?.promoInfo?.mediaGallery
                                            );
                                        }}
                                    ...
                                    <p className="border-r  w-full px-5 ">
                                        N/A
                                    </p>
                                )}
                                {/* video gallery */}
                                {item?.promoInfo?.videoGallery?.length ? (
                                    <p
                                        onClick={() => {
                                            setOpenPromoVideosModal(
                                                !openPromoVideosModal
                                            );
                                            setPromoVideos(
                                                item?.promoInfo?.videoGallery
                                            );
                                        }}
                                    ...
                                    <p className="border-l  w-full px-5 ">
                                        N/A
                                    </p>
                                )}
                            </div>
