...
const AddSubjectClassVariantModal = ({
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await addSubjectClassVariant({ variant });
...
export default AddSubjectClassVariantModal;
