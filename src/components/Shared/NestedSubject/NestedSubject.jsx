  ...
  <Menu placement="bottom-start">
    <MenuHandler>
      <div>
        <Button
          variant="text"
          className="w-full transition-all duration-300 ease-in-out border py-2.5 px-5 rounded-lg border-blue-gray-700/50 flex justify-between text-blue-gray-700/70 text-sm font-medium bg-gray-50 hover:bg-gray-50"
        >
